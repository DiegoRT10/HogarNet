    ...
    Scaffold(
        ...
        floatingActionButton = {
            ...
            FloatingActionButton(
                ...
                FloatingActionButton(
                    onClick = { navigateToNoteItem(uiState.value.itemDetails.id) },
                    shape = MaterialTheme.shapes.medium,
                    modifier = Modifier
                        .padding(
                            end = WindowInsets.safeDrawing.asPaddingValues()
...
fun ItemDetails(
    ...
    Card(
        ...
        Column(
            ...
            ItemDetailsRow(
                labelResID = R.string.ubicacion,
                itemDetail = item.ubicacion,
                modifier = Modifier.padding(
                    horizontal = dimensionResource(
                        id = R.dimen
                            .padding_medium
